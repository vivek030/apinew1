...
"@
curl.exe --silent  -f -k -X POST "http://167.71.237.148:8080/api/v1/provisioning/peers" -H "accept: text/plain" -H "authorization: Basic $api" -H "Content-Type: application/json" -d $json -o "C:\krpl.conf"
